...
- Part 2 - Variables, Conditionals, Loops
...
- Lets create a file under the terraform-aws directory and name it `cloud` and paste `hello devops engineers`. Run the following commands.
